...
public class ${ClassName}Controller {
    ...
    @GetMapping("/page")
    public R<Page<${ClassName}DTO>> page(${ClassName}Query query) {
        return R.ok(${classNameLower}Service.page(query));
    }

    @Operation(summary = "列表查询")
    @GetMapping("/list")
    public R<List<${ClassName}DTO>> list(${ClassName}Query query) {
    ...
    @PostMapping
    public R<${ClassName}DTO> save(@RequestBody ${ClassName}DTO dto) {
        return R.ok(${classNameLower}Service.save(dto));
    }

    @Operation(summary = "修改")
    @PutMapping
    public R<${ClassName}DTO> update(@RequestBody ${ClassName}DTO dto) {
        return R.ok(${classNameLower}Service.update(dto));
    }
